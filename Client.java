...
public class Client implements ActionListener {
	...
	Client(){
		...
		frame.add(p1);
		//====================Arrow icon setup=============================
		ImageIcon icon = new ImageIcon(Client.class.getResource("arrow.png"));
		...
		p1.add(label);
		//===================Profile icon setup=========================
		ImageIcon profileIcon = new ImageIcon(Client.class.getResource("mehedi.png"));
		...
		p1.add(ProfileLabel);
		//================Phone Icon setup================================
		ImageIcon phone = new ImageIcon(Client.class.getResource("phone.png"));
		...
		ImageIcon video = new ImageIcon(Client.class.getResource("video.png"));
		...
		ImageIcon dots = new ImageIcon(Client.class.getResource("dots.png"));
		...
		p1.add(DotLabel);
		//======================Name===============================
		JLabel name=new JLabel("Mehedi Hasan");
